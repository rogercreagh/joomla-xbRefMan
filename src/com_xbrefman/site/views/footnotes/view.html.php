 ...
 * @filesource site/views/footnotes/view.html.php
 * @author Roger C-O
...
class XbrefmanViewFootnotes extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        $document->setMetaData('title', Text::_('XBREFMAN_FOOTNOTES_LISTING').': '.$document->title);
